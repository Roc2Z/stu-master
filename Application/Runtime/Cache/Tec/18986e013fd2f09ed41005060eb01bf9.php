    ...
    <div class="main-content">
        ...
        <div class="main">
            ...
            <div class="data-table">
                ...
                <span class="shenhe"><a href="<?php echo U('article/check',array('mix_id'=>$mix_id));?>" class="ajax-get">审核</a></span>
                <span class="shenhe"><a href="<?php echo U('article/go_back',array('mix_id'=>$mix_id));?>" class="confirm ajax-get">驳回</a></span>
                <span class="shenhe"><a href="<?php echo U('article/delete_apply',array('mix_id'=>$mix_id));?>" class="confirm ajax-get">删除</a></span>
            </div>
            <div class="page"></div>
        </div>
