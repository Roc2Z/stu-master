<?php if (!defined('THINK_PATH')) exit();?><html>
    ...
    <div class="main-content">
        ...
        <div class="main">
            <div class="main-title">已删除文件(<?php echo ($count); ?>)</div>
            <div class="cf">
                <a href="" class="btn">恢复</a>
                        ...
                        <table class="">
                            ...
                            <tbody>
                                <?php if(is_array($moban_info)): foreach($moban_info as $key=>$one): ?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('article/recover',array('mix_id'=>$one['mix_id']));?>" class="ajax-get">恢复</a>
                                        <a href="<?php echo U('article/delete',array('mix_id'=>$one['mix_id']));?>" class="confirm ajax-get">彻底删除</a>
                                        </td>
