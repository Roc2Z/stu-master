<?php if (!defined('THINK_PATH')) exit();?><html>
    ...
    <div class="main-content">
        ...
        <div class="main">
            <div class="main-title">综合素质查看</div>
            <div class="cf">
                        ...
                        <table class="">
                            ...
                            <tbody>
                                <?php if(is_array($moban_info)): foreach($moban_info as $key=>$one): ?><tr>
                                    ...
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name1"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name5"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name2"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name6"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name3"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name4"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name7"]); ?></a></td>
                                    <td><a href="<?php echo U('article/detial1',array('mix_id'=>$one['mix_id']));?>"><?php echo ($one["name6"]); ?></a></td>      
